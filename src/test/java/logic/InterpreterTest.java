...
public class InterpreterTest {
  ...
  public void testCalculateAddSub() {
    ...
    result =
        interpreter.solveAddSub(Arrays.asList("1", "+", "1", "-", "1", "-", "1", "-", "1")).get(0);
    assertThat(result, is("-1.0"));
  }
  ...
  public void testComplexCalculations() {
    ...
    result =
        interpreter
            .interpret(Arrays.asList("2", "*", "3", "+", "16", "/", "8", "-", "-4", "/", "2"))
            .get(0);
  ...
  public void testResolveMulDiv() {
    ...
    result =
        interpreter.solveMulDiv(
            Arrays.asList("1", "+", "2", "*", "2", "+", "1", "+", "4", "/", "2"));
    assertThat(result, is(Arrays.asList("1", "+", "4.0", "+", "1", "+", "2.0")));

    result =
        interpreter.solveMulDiv(
            Arrays.asList("1", "+", "2", "*", "2", "/", "4", "*", "2", "+", "1"));
